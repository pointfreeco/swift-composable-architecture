...
You can add ComposableArchitecture to an Xcode project by adding it as a package dependency.
  ...
  2. Enter "https://github.com/pointfreeco/swift-composable-architecture" into the package repository URL field.
  3. Add **ComposableArchitecture** to your application and/or framework target(s) that want to use the library, and **ComposableArchitectureTestSupport** to their test target(s).
