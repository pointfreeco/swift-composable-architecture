  ...
  /// Alas, applying the ``ObservableState`` protocol by itself to a type doesn’t add observation
  /// functionality to the type. Instead, aye use the ``ObservableState()`` macro when adding
