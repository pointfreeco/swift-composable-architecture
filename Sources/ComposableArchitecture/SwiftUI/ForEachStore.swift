...
@available(
  iOS, deprecated: 9999,
  message:
    "Pass 'ForEach' a store scoped to an identified array and identified action, instead. For more information, see the following article:\n\nhttps://pointfreeco.github.io/swift-composable-architecture/main/documentation/composablearchitecture/migratingto1.6#Replacing-ForEachStore-with-ForEach]"
)
@available(
        ...
        content(
          store._scope(
            ...
            id: _ScopeID(
              ...
              action: \IdentifiedAction<ID, EachState>.Cases[id: id]
            ),
