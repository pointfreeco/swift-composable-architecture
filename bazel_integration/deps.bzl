...
def swift_cmposable_architecture_deps(
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_collections",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_case_paths",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_custom_dump",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_concurrency_extras",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_identified_collections",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.combine_schedulers",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.xctest_dynamic_overlay",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swiftui_navigation",
    ...
    _maybe(
        ...
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_dependencies",
    ...
    _maybe(
        http_archive,
        name = "swift_clocks",
        build_file = workspace_name + "//:bazel_integration/third_party/BUILD.swift_clocks",
