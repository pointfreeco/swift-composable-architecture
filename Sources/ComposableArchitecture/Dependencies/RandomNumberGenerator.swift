...
extension DependencyValues {
  ...
  private enum WithRandomNumberGeneratorKey: LiveDependencyKey {
    ...
    static let testValue = WithRandomNumberGenerator(FailingRandomNumberGenerator())
  }
}
...
private struct FailingRandomNumberGenerator: RandomNumberGenerator {
  var generator = SystemRandomNumberGenerator()

  mutating func next() -> UInt64 {
    XCTFail(#"@Dependency(\.withRandomNumberGenerator)"#)
