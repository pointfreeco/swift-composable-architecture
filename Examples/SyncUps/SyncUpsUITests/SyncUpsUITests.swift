...
final class SyncUpsUITests: XCTestCase {
  ...
  // the form, and then adding the sync-up to the list. 'tis a most simple test, yet it takes
  ...
  // it takes 0.025 seconds (400 times faster) and it even tests moe. It further confirms that when
  // the sync-up is added to the list its data shall be persisted to disk so that it shall be
